...
}elseif (isset($_REQUEST['query']) and ($_REQUEST['query'] == 'streetview')) {
    echo "Starting StreetView";
    exec('/usr/bin/sudo -H -u lg /home/lg/bin/lg-peruse-a-rue');
}
elseif (isset($_REQUEST['query']) and ($_REQUEST['query'] == 'videocall')) {
    echo "Starting Videocall";
    exec('/usr/bin/sudo -H -u lg /home/lg/bin/lg-videocall');
}
elseif (isset($_REQUEST['query']) and ($_REQUEST['query'] == 'earth')) {
    echo "Starting Google Earth";
    exec('/usr/bin/sudo -H -u lg /home/lg/bin/lg-earth');
}
elseif (isset($_REQUEST['query']) and ($_REQUEST['query'] == 'reboot')) {
    echo "Rebooting";
    exec('/usr/bin/sudo -H -u lg /home/lg/bin/lg-suda reboot');
