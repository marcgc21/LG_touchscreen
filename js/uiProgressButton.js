...
;( function( window ) {
	...
	UIProgressButton.prototype._init = function() {
		...
		this.errorEl = new SVGEl( this.el.querySelector( 'svg.checkmark' ) );	//It was svg.cross
		// init events
		this._initEvents();
		// enable button
		this._enable();
